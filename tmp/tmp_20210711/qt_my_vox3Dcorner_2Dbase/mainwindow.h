...
//    QStringList g_DrawMeshXYZList;
    ...
    QStringList g_cornerXZList, g_cornerXZList_tmp;
    QStringList g_cornerYZList, g_cornerYZList_tmp;
    QStringList g_cornerXYList, g_cornerXYList_tmp;

    void func_vox_readHeader();  //データ　3次元配列に格納
    void func_vox_read3Darray(); //voxデータ　3次元配列に格納

    void func_meshSurface_get(); //表示する面をget (隣とマテリアル違いの箇所　3Darray)
    int ***g_voxSurface;
